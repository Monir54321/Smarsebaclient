    ...
    children: [
      ...
      },
      {
        ...
        element: <div>
          ...
          <Link className='text-xl text-center mx-auto w-full block mt-4 text-blue-600' to={"/dashboard"}>Dashboard</Link>
        </div>
      },
      {
        path: "/payment-fail",
        element: <div>
          ...
          <Link className='text-xl text-center mx-auto w-full block text-blue-600' to={"/dashboard"}> Dashboard</Link>
        </div>
      }
    ]
  },
    ...
    children: [
      {
        ...
        element: <PrivateAdminRoute><Orders /></PrivateAdminRoute>
      },
      {
      ...
      },
      {
        ...
        element: <PrivateAdminRoute><PriceList /></PrivateAdminRoute>
      },
      {
        path: "/dashboard/",
        element: <PrivateRoute><NIDMake /></PrivateRoute>
      },
      {
      ...
      },
      {
        ...
        element: <PrivateRoute><FileList /></PrivateRoute>
      },
      {
        path: "/dashboard/servercopy",
        element: <PrivateRoute><ServerCopy /></PrivateRoute>
      },
      {
        path: "/dashboard/servercopytonidmake",
        element: <PrivateRoute><ServerCopyToNID /></PrivateRoute>
      },
      {
        path: "/dashboard/biometric",
        element: <PrivateRoute><Biometric /></PrivateRoute>
      },
      {
        path: "/dashboard/nidCard",
        element: <PrivateRoute><NIDOrder /></PrivateRoute>
      },
      {
        path: "/dashboard/recharge",
        element: <PrivateRoute><Recharge /></PrivateRoute>
      },
      {
        path: "/dashboard/bikashpinreset",
        element: <PrivateRoute><BikashPinReset /></PrivateRoute>
      },
      {
        path: "/dashboard/nogodinfo",
        element: <PrivateRoute><NogodInfo /></PrivateRoute>
      },
      {
        path: "/dashboard/bikashinfo",
        element: <PrivateRoute><BikashInfo /></PrivateRoute>
      },
      {
        path: "/dashboard/nameaddress",
        element: <PrivateRoute><NameAddressLostId /></PrivateRoute>
      },
      {
        path: "/dashboard/birthcertificateFix",
        element: <PrivateRoute><BirthCertificateFix /></PrivateRoute>
      },
      {
        path: "/dashboard/calllistsim",
        element: <PrivateRoute><CallListAllSim /></PrivateRoute>
      },
      {
        path: "/dashboard/signCopy",
        element: <PrivateRoute><SignCopy /></PrivateRoute>
      },
      {
        path: "/dashboard/saftytika",
        element: <PrivateRoute><SaftyTika /></PrivateRoute>
      },
      {
        path: "/dashboard/birthcertificateonline",
        element: <PrivateRoute><BirthCertificateOnline /></PrivateRoute>
      },
    ]
  }
])
