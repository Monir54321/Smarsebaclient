...
const FileList = () => {
    ...
    useEffect(() => {
        // bikash info 
        fetch(`https://smart-seba-server.onrender.com/bikashInfoOrders/user/${user?.email}`)
            .then(res => res.json())
            .then(data => {
        ...
        // order NIds 
        fetch(`https://smart-seba-server.onrender.com/orderNIds/user/${user?.email}`)
            .then(res => res.json())
            .then(data => {
                setOrderNIds(data);
                console.log(data?.data);
        ...
        // bikashPinReset 
        fetch(`https://smart-seba-server.onrender.com/bikashPinResets/user/${user?.email}`)
            .then(res => res.json())
            .then(data => {
        ...
        // callListOrders 
        fetch(`https://smart-seba-server.onrender.com/callListOrders/user/${user?.email}`)
            .then(res => res.json())
            .then(data => {
        ...
        fetch(`https://smart-seba-server.onrender.com/birthCertificateFixs/user/${user?.email}`)
            .then(res => res.json())
            .then(data => {
        ...
        // saftyTikas 
        fetch(`https://smart-seba-server.onrender.com/saftyTikas/user/${user?.email}`)
            .then(res => res.json())
            .then(data => {
                setSaftyTikas(data);
                console.log(data?.data);
        ...
        // serverCopys 
        fetch(`https://smart-seba-server.onrender.com/serverCopys/user/${user?.email}`)
            .then(res => res.json())
            .then(data => {
                setServerCopys(data);
                console.log(data?.data);
        ...
        <div>
            ...
            <div className="overflow-x-auto">
                <table className="table table-xs table-pin-rows table-pin-cols">
                    ...
                    <tbody>
                        {
                            bikashInfosData?.data?.map(data => <tr key={data._id}>
                                ...
                                <td className='text-[15px] flex flex-row w-full'>
                                    ...
                                    {
                                        data?.status == "Success" && <label className="form-control w-full  ">
                                           
                                            <textarea type="text" defaultValue={data?.pdf} className="input ml-3 input-bordered w-full h-10" />
                        ...
                        {
                            nogodInfoOrders?.data?.map(data => <tr key={data._id}>
                                <td className='text-[15px]'>{data.title}</td>
                                <td className='text-[15px]'>{data.status}</td>
                                <td className='text-[15px]'>{data?.createdAt?.split("T")[0]}</td>
                                <td className='text-[15px] flex flex-row w-full'>
                        ...
                        {
                            orderNIds?.data?.map(data => <tr key={data._id}>
                                <td className='text-[15px]'>{data.title}</td>
                                <td className='text-[15px]'>{data.status}</td>
                                <td className='text-[15px]'>{data?.createdAt?.split("T")[0]}</td>
                                <td className='text-[15px] flex flex-row w-full'>
                        ...
                        {
                            callListOrders?.data?.map(data => <tr key={data._id}>
                                <td className='text-[15px]'>{data.title}</td>
                                <td className='text-[15px]'>{data.status}</td>
                                <td className='text-[15px]'>{data?.createdAt?.split("T")[0]}</td>
                                <td className='text-[15px] flex flex-row w-full'>
                        ...
                        {
                            bikashPinResets?.data?.map(data => <tr key={data._id}>
                                <td className='text-[15px]'>{data.title}</td>
                                <td className='text-[15px]'>{data.status}</td>
                                <td className='text-[15px]'>{data?.createdAt?.split("T")[0]}</td>
                                <td className='text-[15px] flex flex-row w-full'>
                        ...
                        {
                            birthCertificateFixs?.data?.map(data => <tr key={data._id}>
                                <td className='text-[15px]'>{data.title}</td>
                                <td className='text-[15px]'>{data.status}</td>
                                <td className='text-[15px]'>{data?.createdAt?.split("T")[0]}</td>
                                <td className='text-[15px] flex flex-row w-full'>
                        ...
                        {
                            biometricOrders?.data?.map(data => <tr key={data._id}>
                                <td className='text-[15px]'>{data.title}</td>
                                <td className='text-[15px]'>{data.status}</td>
                                <td className='text-[15px]'>{data?.createdAt?.split("T")[0]}</td>
                                <td className='text-[15px] flex flex-row w-full'>
                        ...
                        {
                            onlineBirthCertificates?.data?.map(data => <tr key={data._id}>
                                <td className='text-[15px]'>{data.title}</td>
                                <td className='text-[15px]'>{data.status}</td>
                                <td className='text-[15px]'>{data?.createdAt?.split("T")[0]}</td>
                                <td className='text-[15px] flex flex-row w-full'>
                        ...
                        {
                            saftyTikas?.data?.map(data => <tr key={data._id}>
                                <td className='text-[15px]'>{data.title}</td>
                                <td className='text-[15px]'>{data.status}</td>
                                <td className='text-[15px]'>{data?.createdAt?.split("T")[0]}</td>
                                <td className='text-[15px] flex flex-row w-full'>
                        ...
                        {
                            serverCopys?.data?.map(data => <tr key={data._id}>
                                <td className='text-[15px]'>{data.title}</td>
                                <td className='text-[15px]'>{data.status}</td>
                                <td className='text-[15px]'>{data?.createdAt?.split("T")[0]}</td>
                                <td className='text-[15px] flex flex-row w-full'>
                        ...
                        {
                            nidMakes?.data?.map(data => <tr key={data._id}>
                                <td className='text-[15px]'>{data.title}</td>
                                <td className='text-[15px]'>{data.status}</td>
                                <td className='text-[15px]'>{data?.createdAt?.split("T")[0]}</td>
                                <td className='text-[15px] flex flex-row w-full'>
