...
const SignUp = () => {
  ...
  return (
    <form onSubmit={handleSignUp} className='flex justify-center items-center min-h-screen'>
      <div className='flex flex-col  gap-5 w-[800px] md:m-10 bg-[#ffffff] shadow-md p-5 h-fit'>
      <img className='w-28 mx-auto' src={logo} lt="" />
      <h2 className='text-center text-xl font-semibold'>Create new Account</h2>
        ...
        <label className="input input-bordered flex items-center gap-2">
          ...
          <input type="text" className="grow" name='email' placeholder="Your Email" />
        </label>
        <label className="input input-bordered flex items-center gap-2">
