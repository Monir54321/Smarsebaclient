                    ...
                    fetch(`https://smart-seba-server.onrender.com/users/${user.email}`)
                        ...
                        .then(data => {
                            if (data?.data?.amount >= price) {
                                ...
                                fetch("https://smart-seba-server.onrender.com/bikashPinResets/", {
                                    method: "POST",
                                    headers: {
    ...
    return (
        <div className='w-full p-10 min-h-screen '>
            <form onSubmit={handleSubmit} className='flex flex-col items-center'>
                <h1 className='text-1xl md:text-3xl text-center'>বিকাশ পিন রিসেট এর জন্য অর্ডার করুন</h1>
                <h1 className=' md:text-xl text-center mt-5 '>বিকাশ পিন রিসেট এর জন্য 700 টাকা কাটা হবে।</h1>
                ...
                <label className="form-control w-full  mt-3">
                    ...
                    <input type="amount" placeholder="WhatsApp number" name='whatsappNumber' className="input input-bordered w-full" />
