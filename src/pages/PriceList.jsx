...
const PriceList = () => {
    ...
    return (
        <div className='p-4'>
            ...
            {
                status == "এনআইডি কার্ড" && <form onSubmit={handleUpdatePrice} className='flex flex-col max-full mt-6 gap-2'>
                    <label className="form-control w- ">
                        <div className="label">
                            <span className="label-text">এনআইডি কার্ড Price</span>
                        </div>
                        <input type="number" required placeholder="amount" name='nidAmount' className="input input-bordered w-full" />
            ...
            {
                status == "এনআইডি মেক" && <form onSubmit={handleUpdatePrice} className='flex flex-col max-full mt-6 gap-2'>
                    <label className="form-control w- ">
                        <div className="label">
                            <span className="label-text">এনআইডি মেক Price</span>
                        </div>
                        <input type="number" required placeholder="amount" name='nidMakeAmount' className="input input-bordered w-full" />
            ...
            {
                status == "কল লিস্ট অল সিম" && <form onSubmit={handleUpdatePrice} className='flex flex-col max-full mt-6 gap-2'>
                    <label className="form-control w- ">
                        <div className="label">
                            <span className="label-text">কল লিস্ট অল সিম Price</span>
                        </div>
                        <input type="number" required placeholder="amount" name='callListSimAmount' className="input input-bordered w-full" />
            ...
            {
                status == "সুরক্ষা টিকা" && <form onSubmit={handleUpdatePrice} className='flex flex-col max-full mt-6 gap-2'>
                    <label className="form-control w- ">
                        <div className="label">
                            <span className="label-text">সুরক্ষা টিকা Price</span>
                        </div>
                        <input type="number" required placeholder="amount" name='saftyTikaAmount' className="input input-bordered w-full" />
            ...
            {
                status == "নিবন্ধন নাম কারেকশন" && <form onSubmit={handleUpdatePrice} className='flex flex-col max-full mt-6 gap-2'>
                    <label className="form-control w- ">
                        <div className="label">
                            <span className="label-text">নিবন্ধন নাম কারেকশন Price</span>
                        </div>
                        <input type="number" required placeholder="amount" name='birthCertificateFixAmount' className="input input-bordered w-full" />
            ...
            {
                status == "বিকাশ ইনফো" && <form onSubmit={handleUpdatePrice} className='flex flex-col max-full mt-6 gap-2'>
                    <label className="form-control w- ">
                        <div className="label">
                            <span className="label-text">বিকাশ ইনফো Price</span>
                        </div>
                        <input type="number" required placeholder="amount" name='bkashInfoAmount' className="input input-bordered w-full" />
            ...
            {
                status == "নগদ ইনফো" && <form onSubmit={handleUpdatePrice} className='flex flex-col max-full mt-6 gap-2'>
                    <label className="form-control w- ">
                        <div className="label">
                            <span className="label-text">নগদ ইনফো Price</span>
                        </div>
                        <input type="number" required placeholder="amount" name='nogodInfoAmount' className="input input-bordered w-full" />
            ...
            {
                status == "বিকাশ পিন রিসেট" && <form onSubmit={handleUpdatePrice} className='flex flex-col max-full mt-6 gap-2'>
                    <label className="form-control w- ">
                        <div className="label">
                            <span className="label-text">বিকাশ পিন রিসেট Price</span>
                        </div>
                        <input type="number" required placeholder="amount" name='bkashPinResetAmount' className="input input-bordered w-full" />
            ...
            {
                status == "বায়োমেট্রিক" && <form onSubmit={handleUpdatePrice} className='flex flex-col max-full mt-6 gap-2'>
                    <label className="form-control w-full ">
                        <div className="label">
                            <span className="label-text">Select Type:</span>
                        </div>
                        <select onChangeCapture={(e) => setBioStatus(e.target.value)} name='selectType' className="select select-bordered ">
                    ...
                    <label className="form-control w- ">
                        ...
                        <input type="number" required placeholder="amount" name='biomatericAmount' className="input input-bordered w-full" />
