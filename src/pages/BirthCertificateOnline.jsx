...
const BirthCertificateOnline = () => {
    ...
    useEffect(() => {
        fetch(`https://smart-seba-server.onrender.com/onlineBirthCertificates/user/${user?.email}`)
        .then(res => res.json())
        .then(data => {
    ...
    const handleSubmit = (e) => {
        ...
        const unionPowrosovaSityCorporation = e.target.unionPowrosovaSityCorporation.value
        ...
        fetch(`https://smart-seba-server.onrender.com/users/${user.email}`)
            ...
            .then(data => {
                if (data?.data?.amount >= 200) {
                    ...
                    // post data to database
                    fetch("https://smart-seba-server.onrender.com/onlineBirthCertificates/", {
                        method: "POST",
                        headers: {
    ...
    return (
        <div className='w-full p-10 min-h-screen '>
            <form onSubmit={handleSubmit} className='flex flex-col items-center'>
                ...
                <h1 className=' md:text-xl text-center mt-5 '>আইডি কার্ড এর জন্য 200 টাকা কাটা হবে ।</h1>

                <label className="form-control w-full ">
                    <div className="label">
                        <span className="label-text">নাম বাংলা</span>
                    </div>
                    <input type="text" placeholder="নাম বাংলাঃ" name='banglaName' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Name english" name='englishName' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="বাবা-মায়ের কততম সন্তানঃ" name='childNumber' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="লিঙ্গঃ" name='gender' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="মোবাইলঃ" name='mobile' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Date of birth:" name='dateOfBirth' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="বিভাগ" name='bivag' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="জেলা" name='jela' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="উপজেলা" name='upazila' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="ইউনিয়ন/পৌরসভা/সিটি করপোরেশন" name='unionPowrosovaSityCorporation' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="ওয়ার্ড নং" name='ordernumber' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="ডাকঘর" name='dakghar' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Post Office" name='postOffice' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="গ্রাম" name='gram' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Village " name='village' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="পিতার নাম" name='fatherNameBangla' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Father Name" name='fatherNameEnglish' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Father NID Number" name='fatherNIDNumber' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Father Birth Certificate" name='fatherBirthCertificate' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="মাতার নাম" name='motherNameBangla' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Mother Name" name='motherNameEnglish' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Mother NID Number" name='motherNIDNumber' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="Mother Birth Certificate" name='motherBirthCertificate' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="জন্ম স্থান" name='birthLocation' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="স্থায়ী ঠিকানা" name='permanentLocation' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="আবেদনকারীর whatsapp নাম্বার" name='whatsAppNumber' className="input input-bordered w-full" />
