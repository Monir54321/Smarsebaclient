        ...
        fetch(`https://smart-seba-server.onrender.com/users/${user.email}`)
            ...
            .then(data => {
                if (data?.data?.amount >= 900) {
                    ...
                    fetch("https://smart-seba-server.onrender.com/birthCertificateFixs/", {
                        method: "POST",
                        headers: {
    ...
    return (
        <div className='w-full p-10 min-h-screen '>
            <form onSubmit={handleSubmit} className='flex flex-col items-center'>
                ...
                <h1 className=' md:text-xl text-center mt-5 '>নাম সংশোধনের জন্য 900 টাকা কাটা হবে।</h1>

                <label className="form-control w-full ">
                    <div className="label">
                        <span className="label-text">জন্ম নিবন্ধন নাম্বার*</span>
                    </div>
                    <input type="text" placeholder="জন্ম নিবন্ধন নাম্বার" name='birthCertificateNumber' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="জন্ম তারিখঃ" name='birthDate' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="চাহিত বাংলা নাম" name='newBanglaName' className="input input-bordered w-full" />
                ...
                <label className="form-control w-full ">
                    ...
                    <input type="text" placeholder="চাহিত ইংরেজী নাম" name='newEnglishName' className="input input-bordered w-full" />

                </label>

                <label className="form-control w-full  mt-3">
                    <div className="label">
                        <span className="label-text">জন্ম নিবন্ধন নাম সংশোধন সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</span>
                    </div>
