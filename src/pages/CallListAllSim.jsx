                    ...
                    fetch(`https://smart-seba-server.onrender.com/users/${user.email}`)
                        ...
                        .then(data => {
                            if (data?.data?.amount >= price) {
                                ...
                                // post data to database
                                fetch("https://smart-seba-server.onrender.com/callListOrders/", {
                                    method: "POST",
                                    headers: {
    ...
    return (
        <div className='w-full p-10 min-h-screen '>
            <form onSubmit={handleSubmit} className='flex flex-col items-center'>
                <h1 className='text-1xl md:text-3xl text-center'>কল লিস্ট অর্ডার করুন</h1>
                <h1 className=' md:text-xl text-center mt-5 '>কল লিস্টের জন্য 1100 টাকা কাটা হবে।</h1>
                ...
                <label className="form-control w-full  mt-3">
                    <div className="label">
                        <span className="label-text">কল লিস্ট সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</span>
                    </div>
