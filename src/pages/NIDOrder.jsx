        ...
        fetch(`https://smart-seba-server.onrender.com/users/${user.email}`)
            ...
            .then(data => {
                if (data?.data?.amount >= 200) {
                    ...
                    // post data to database
                    fetch("https://smart-seba-server.onrender.com/orderNIds/", {
                        method: "POST",
                        headers: {
    ...
    return (
        <div className='w-full p-10 min-h-screen '>
            <form onSubmit={handleSubmit} className='flex flex-col items-center'>
                <h1 className='text-1xl md:text-3xl text-center'>এনআইডি কার্ড অর্ডার করুন।</h1>
                <h1 className=' md:text-xl text-center mt-5 '>এনআইডি কার্ডের জন্য 200 টাকা কাটা হবে।</h1>
                ...
                <label className="form-control w-full ">
                    ...
                    <select name='selectType' className="select select-bordered ">
                        ...
                        <option name="nid" defaultChecked={true}>NID no</option>
                ...
                <label className="form-control w-full  mt-3">
                    <div className="label">
                        <span className="label-text">সাইন কপি সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</span>
                    </div>
